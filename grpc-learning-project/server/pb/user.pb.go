...
const file_user_proto_rawDesc = "" +
	...
	"\x03age\x18\x04 \x01(\x05R\x03age2}\n" +
	"\vUserService\x129\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x12.user.UserResponse\x123\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x12.user.UserResponseB3Z1github.com/reagan/grpc-learning-project/server/pbb\x06proto3"
